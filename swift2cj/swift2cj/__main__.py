"""CLI entry: ``python -m swift2cj input.swift -o output.cj``."""
...
def main(argv: list = None) -> int:
    parser = argparse.ArgumentParser(
        prog="swift2cj",
        description="Convert a Swift source file to Cangjie source.",
    )
    parser.add_argument("input", help="Swift source file (.swift)")
    ...
    if args.report:
        sys.stderr.write(
            f"[swift2cj] chunks={result.chunks} "
