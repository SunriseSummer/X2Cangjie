...
- 用例总数：**60**
- 模式覆盖率（confident / chunks）：**63.16%** (312 / 494)
- Go 源编译（`go vet`）：**60 / 60** (100.00%)
- Cangjie 编译通过：**60 / 60** (100.00%)
- 运行输出匹配：**59 / 60** (98.33%)
- 综合质量分（0.4×覆盖率 + 0.4×编译 + 0.2×运行）：**85.49%**
...
| `30_mixed_program` | 8 | 6 | 2 | 75% | ✅ | ✅ | ✅ | 90.00% |
