...
- 用例总数：**50**
- 模式覆盖率（confident / chunks）：**67.93%** (250 / 368)
- Go 源编译（`go vet`）：**50 / 50** (100.00%)
- Cangjie 编译通过：**50 / 50** (100.00%)
- 运行输出匹配：**49 / 50** (98.00%)
- 综合质量分（0.4×覆盖率 + 0.4×编译 + 0.2×运行）：**86.83%**
...
| `35_max_in_slice` | 4 | 2 | 2 | 50% | ✅ | ✅ | ✅ | 80.00% |
