...
- 用例总数：**45**
- 模式覆盖率（confident / chunks）：**91.16%** (196 / 215)
- Go 源编译（`go vet`）：**45 / 45** (100.00%)
- Cangjie 编译通过：**43 / 45** (95.56%)
- 运行输出匹配：**42 / 45** (93.33%)
- 综合质量分（0.4×覆盖率 + 0.4×编译 + 0.2×运行）：**94.15%**
...
| `08_recursion` | 5 | 4 | 1 | 80% | ✅ | ✅ | ✅ | 92.00% |
| `09_fibonacci` | 5 | 4 | 1 | 80% | ✅ | ✅ | ✅ | 92.00% |
...
| `18_sum_array` | 7 | 6 | 1 | 86% | ✅ | ✅ | ✅ | 94.29% |
| `19_switch` | 7 | 6 | 1 | 86% | ✅ | ✅ | ✅ | 94.29% |
| `20_struct_basic` | 4 | 4 | 0 | 100% | ✅ | ✅ | ✅ | 100.00% |
| `21_struct_methods` | 4 | 4 | 0 | 100% | ✅ | ✅ | ✅ | 100.00% |
| `22_interface` | 5 | 4 | 1 | 80% | ✅ | ❌ | ❌ | 32.00% |
...
- cjc 诊断：`error: expected '=', found keyword 'struct'`
