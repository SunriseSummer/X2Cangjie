...
- Cangjie 编译通过：**17 / 60** (28.33%)
- 运行输出匹配：**16 / 60** (26.67%)
- 综合质量分（0.4×覆盖率 + 0.4×编译 + 0.2×运行）：**56.67%**
...
- cjc 诊断：`error: expected ';' or '<NL>', found 'xs'`
...
- cjc 诊断：`error: expected type argument`
